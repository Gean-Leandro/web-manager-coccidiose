                            ...
                            <ul>
                                { filtradas.map((specie) => (
                                    ...
                                    <div className="flex items-center gap-2 *:p-1">
                                        <Link to={'/atualizar-eimeria'} state={specie} className={`${login !== "admin"? "hidden" : ""} hover:border-[2px] hover:border-mygray-400 hover:bg-mygray-300 rounded-[8px]`}>
